...
def login():
    ...
    if id == "Meerhansayyed00@gmail.com" and key == "9833":
        main()
    else:
        user_entry.focus()
...
#chatbot
import nltk
nltk.download('punkt') # Download the necessary data for NLTK's chat functionality
from nltk.chat.util import Chat, reflections # Use Chat instead of chat

# Define the rules or pairs for the chatbot
pairs = [
    (
        r"my name is (.*)",
    ...
    (
        r"what is your name",
        ["I am a chatbot created by python's NLTK library ", ]
    ),
    (
        r"how are you",
        ["I'm doing well\nHow about you ?", ]
    ...
    (
        r"I am (.*)",
        ["nice to hear that", "Is it fine?", ]
    ),
]

# Start the chatbot
print("Welcome to the chatbot! Type 'quit' to exit.")
Chat(pairs, reflections).converse() # Use Chat instead of chat and call the converse() method